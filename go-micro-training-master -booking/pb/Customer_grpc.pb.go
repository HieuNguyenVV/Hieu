...
type CustomerServiceClient interface {
	...
	ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*MessageChangePassword, error)
	BookingHistory(ctx context.Context, in *FindCustomerRequest, opts ...grpc.CallOption) (*Customer, error)
...
func (c *customerServiceClient) ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*MessageChangePassword, error) {
	out := new(MessageChangePassword)
...
func (c *customerServiceClient) BookingHistory(ctx context.Context, in *FindCustomerRequest, opts ...grpc.CallOption) (*Customer, error) {
	out := new(Customer)
...
func (c *customerServiceClient) FindCustomer(ctx context.Context, in *FindRequest, opts ...grpc.CallOption) (*FindResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/booking.CustomerService/FindCustomer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CustomerServiceServer interface {
	...
	ChangePassword(context.Context, *ChangePasswordRequest) (*MessageChangePassword, error)
	BookingHistory(context.Context, *FindCustomerRequest) (*Customer, error)
...
func (UnimplementedCustomerServiceServer) ChangePassword(context.Context, *ChangePasswordRequest) (*MessageChangePassword, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangePassword not implemented")
}
func (UnimplementedCustomerServiceServer) BookingHistory(context.Context, *FindCustomerRequest) (*Customer, error) {
...
func _CustomerService_BookingHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).BookingHistory(ctx, req.(*FindCustomerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CustomerService_FindCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/booking.CustomerService/FindCustomer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
